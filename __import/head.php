<!-- font -->
<link rel="stylesheet" href="https://simorghbu.github.io/dev/src/font/iranyekan-fa/font-face.css" type="text/css">
<!-- color palette -->
...
<!-- attach -->
<link rel="stylesheet" href="./attach.css" type="text/css">
<!-- bootstrap -->
...
<style>
    :root{
        --bs-font-family: IRANSans,"IRANSans";
